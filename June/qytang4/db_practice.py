...
cursor.execute("insert into test(t1,t2) values(14, 'welcome to qytang')")
cursor.execute("insert into test(t1,t2) values(15, 'welcome to python')")
cursor.execute("insert into test(t1,t2) values(16, 'welcome to FRanK')")
