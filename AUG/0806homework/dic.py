...
game_data = {
    ...
    "equipment": {
        ...
        "armor": {
            ...
            "chest1": {"name": "北境铠甲1", "def": 150},
            "chest2": {"name": "北境铠甲2", "def": 45},
            "chest3": {"name": "北境铠甲3", "def": 55},
            "chest4": {"name": "北境铠甲4", "def": 35},
            "chest5": {"name": "北境铠甲3", "def": 155},
            "chest6": {"name": "北境铠甲4", "def": 135}
        }
    },
    "missions": [
        {
        ...
        },
{
            ...
            "name": "陈涛1",
            "attendance": {"2025-08-01": "Present", "2025-08-02": "Present"},
            "scores": {"math": 0, "english": 0, "physics": 5}
        }
    ]
}
logistics_data = {
